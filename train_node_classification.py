...
if __name__ == "__main__":
    ...
    for run in range(args.num_runs):
        ...
        if args.model_name in ['JODIE', 'DyRep', 'TGN']:
            for node_id, node_raw_messages in model[0].memory_bank.node_raw_messages.items():
                ...
                for node_raw_message in node_raw_messages:
                    ...
                    new_node_raw_messages.append((node_raw_message[0], node_raw_message[1]))
        ...
        for epoch in range(args.num_epochs):
            ...
            train_y_trues = jt.concat(train_y_trues, dim=0)
            train_y_predicts = jt.concat(train_y_predicts, dim=0)
            ...
            logger.info(f'Epoch: {epoch + 1}, learning rate: {optimizer.lr}, train loss: {train_total_loss:.4f}')
